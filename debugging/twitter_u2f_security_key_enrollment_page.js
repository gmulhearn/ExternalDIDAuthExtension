(function (e) {
  ...
  Array.prototype.forEach &&
    Array.prototype.forEach.call("foo", function (e, t, n) {
      typeof n != "object" && (g = !1);
    });
  if (!Array.prototype.forEach || !g)
  ...
  Array.prototype.map ||
    ...
    Array.prototype.filter ||
      (Array.prototype.filter = function (t) {
        ...
        if (s(t) != "[object Function]")
          throw new TypeError(t + " is not a function");
        for (var f = 0; f < i; f++)
          f in r && ((u = r[f]), t.call(a, u, f, n) && o.push(u));
        return o;
      }),
    ...
    Array.prototype.reduceRight ||
      (Array.prototype.reduceRight = function (t) {
        ...
        if (u < 0) return o;
        do u in this && (o = t.call(void 0, o, r[u], u, n));
        while (u--);
        return o;
      });
  if (!Array.prototype.indexOf || [0, 1].indexOf(1, 2) != -1)
    Array.prototype.indexOf = function (t) {
      ...
      if (!r) return -1;
      var i = 0;
      arguments.length > 1 && (i = M(arguments[1])),
  ...
  if (!Array.prototype.lastIndexOf || [0, 1].lastIndexOf(0, -3) != -1)
    Array.prototype.lastIndexOf = function (t) {
      ...
      if (!r) return -1;
      var i = r - 1;
      arguments.length > 1 && (i = Math.min(i, M(arguments[1]))),
  ...
  if (!Object.keys) {
    var y = !0,
      ...
      w = b.length;
    for (var E in { toString: null }) y = !1;
  ...
  if (
    ...
    new Date(S).toISOString().indexOf(x) === -1
  )
          ...
          (Number.prototype.toFixed = function (e) {
            ...
            return (
              t > 0
                ? ((p = f.length),
                  p <= t
                    ? (f = r + "0.0000000000000000000".slice(0, t - p + 2) + f)
                    : (f = r + f.slice(0, p - t) + "." + f.slice(p - t)))
                : (f = r + f),
              f
            );
          });
          ...
          while ((a = t.exec(r))) {
            ...
            if (f > o) {
              i.push(r.slice(o, a.index)),
                ...
                a.length > 1 &&
                  a.index < r.length &&
                  Array.prototype.push.apply(i, a.slice(1)),
                (l = a[0].length),
                (o = f);
              if (i.length >= n) break;
            }
...
$(".js-userDropdown").each(function (e, t) {
  ...
  $(".MobileHoverEffect").bind("click", function (e) {
    var t = $(e.target);
    $(".Dropdown-menu").has(t).length ||
      (e.preventDefault(), $(this).toggleClass("hover_effect"));
  }); // Attach a location.reload() to all "retry" links.
$(".js-retryLink").on("click", function (e) {
  e.stopPropagation(), e.preventDefault(), window.location.reload();
});
function inIframe() {
  try {
...
inIframe() && $(".TopNav").hide();
(function () {
  function e(e) {
    return function () {
      window.top.postMessage({ bouncer: !0, event: e }, "*");
    };
  }
  function t() {
    e("load")(),
      $("div.js-bouncerCompleteRedirect").length &&
        (e("complete")(),
        setTimeout(function () {
          window.location.replace("/");
        }, 1e3));
  }
  $(window).on("beforeunload", e("beforeunload")),
    $(window).on("load", t),
    $("form.js-bouncerComplete").on("submit", e("complete")),
    $("form.js-bouncerCancel").on("submit", e("cancel")),
    $("form.js-bouncer2FAComplete").on("submit", e("2fa_complete")),
    $("a.js-bouncerComplete").on("click", e("complete")),
    $("a.js-bouncerCancel").on("click", e("cancel")),
    $("a.js-bouncer2FAComplete").on("click", e("2fa_complete")),
    $("a.js-passwordResetExit").on("click", e("password_reset_complete"));
})();
...
$radioButtons.change(function () {
  ...
  $radioButtons.each(function () {
    ...
    e && $("input[name='submit']").removeAttr("disabled");
...
var hasNativeApiSupport =
  (typeof u2f != "undefined" && typeof u2f.register != "undefined") ||
  (typeof chrome != "undefined" && typeof chrome.runtime != "undefined");

if (typeof u2f == "undefined") {
  console.log("u2f undefined!")("use strict");
  var u2f = u2f || {},
    js_api_version;
  (u2f.EXTENSION_ID = "kmendfapggjehodndflmmgagdbamhnfd"),
    ...
    (u2f.getChromeRuntimePort_ = function (e) {
      var t = chrome.runtime.connect(u2f.EXTENSION_ID, {
    ...
    (u2f.formatSignRequest_ = function (e, t, n, r, i) {
    ...
    (u2f.formatRegisterRequest_ = function (e, t, n, r, i) {
      if (js_api_version === undefined || js_api_version < 1.1) {
        for (var s = 0; s < n.length; s++) n[s].appId = e;
        var o = [];
        for (var s = 0; s < t.length; s++)
          o[s] = {
            version: t[s].version,
            challenge: n[0],
            keyHandle: t[s].keyHandle,
            appId: e,
          };
        return {
    ...
    (u2f.WrappedAuthenticatorPort_.prototype.onRequestUpdate_ = function (
      ...
      var n = JSON.parse(t.data),
        ...
        i = n.errorCode,
        s = null;
      n.hasOwnProperty("data") && (s = JSON.parse(n.data)), e({ data: s });
    }),
    (u2f.WrappedAuthenticatorPort_.INTENT_URL_BASE_ =
    ...
    (u2f.WrappedIosPort_.prototype.addEventListener = function (e, t) {
      var n = e.toLowerCase();
      n !== "message" && console.error("WrappedIosPort only supports message");
    }),
    (u2f.getIframePort_ = function (e) {
      ...
      var r = new MessageChannel(),
        i = function (t) {
          t.data == "ready"
            ? (r.port1.removeEventListener("message", i), e(r.port1))
    ...
    (u2f.responseHandler_ = function (e) {
      var t = e.data,
        n = t.requestId;
      if (!n || !u2f.callbackMap_[n]) {
        console.error("Unknown or missing requestId in response.");
        return;
      }
      var r = u2f.callbackMap_[n];
      delete u2f.callbackMap_[n], r(t.responseData);
    }),
    (u2f.sign = function (e, t, n, r, i) {
      js_api_version === undefined
        ? u2f.getApiVersion(function (s) {
            (js_api_version =
              s.js_api_version === undefined ? 0 : s.js_api_version),
              console.log("Extension JS API Version: ", js_api_version),
              u2f.sendSignRequest(e, t, n, r, i);
          })
        : u2f.sendSignRequest(e, t, n, r, i);
    }),
    (u2f.sendSignRequest = function (e, t, n, r, i) {
      u2f.getPortSingleton_(function (s) {
        var o = ++u2f.reqCounter_;
        u2f.callbackMap_[o] = r;
        var u = typeof i != "undefined" ? i : u2f.EXTENSION_TIMEOUT_SEC,
          a = u2f.formatSignRequest_(e, t, n, u, o);
        s.postMessage(a);
      });
    }),
    (u2f.register = function (e, t, n, r, i) {
      js_api_version === undefined
        ? u2f.getApiVersion(function (s) {
            (js_api_version =
              s.js_api_version === undefined ? 0 : s.js_api_version),
              console.log("Extension JS API Version: ", js_api_version),
              u2f.sendRegisterRequest(e, t, n, r, i);
          })
        : u2f.sendRegisterRequest(e, t, n, r, i);
    }),
    (u2f.sendRegisterRequest = function (e, t, n, r, i) {
      u2f.getPortSingleton_(function (s) {
        var o = ++u2f.reqCounter_;
        u2f.callbackMap_[o] = r;
        var u = typeof i != "undefined" ? i : u2f.EXTENSION_TIMEOUT_SEC,
          a = u2f.formatRegisterRequest_(e, n, t, u, o);
        s.postMessage(a);
      });
    }),
    (u2f.getApiVersion = function (e, t) {
      u2f.getPortSingleton_(function (n) {
        if (n.getPortType) {
          var r;
        ...
        var s = {
          ...
          timeoutSeconds:
            typeof t != "undefined" ? t : u2f.EXTENSION_TIMEOUT_SEC,
          requestId: i,
        };
        n.postMessage(s);
      });
    ...
    u2f.register(
      ...
      function (t) {
        if (t.errorCode) {
          ...
          switch (t.errorCode) {
            case 1:
              n = $("#IncorrectResponseError");
              break;
            case 2:
              n = $("#URLNotSupportedError");
              break;
            case 3:
              n = $("#NotSupportedClientError");
              break;
            case 4:
              n = $("#IneligibleDeviceError");
              break;
            default:
              n = $("#TimeoutError");
          }
          n.removeClass("hidden"),
            setTimeout(function () {
              n.addClass("hidden"), enroll(e);
            }, 3e3);
        } else
          (document.getElementById("u2f_challenge_response").value =
            JSON.stringify(t)),
...
function webAuthnCreate(e) {
  if (!window.PublicKeyCredential) throw "Client does not support WebAuthn";
  var t = {
    publicKey: {
      rp: e.rp,
      attestation: "none",
      ...
      challenge: toByteArray(e.challenge),
      excludeCredentials: excludedCredentialsToByteArray(e.excludeCredentials),
    },
  };
  navigator.credentials
    ...
    .then(function (e) {
      const t = {};
      "id" in e && (t.id = e.id), "type" in e && (t.type = e.type);
      if (!e.response)
        throw "Get assertion response lacking 'response' attribute";
      t.clientExtensionResults = {};
      const n = {};
      (n.clientDataJSON = fromByteArray(e.response.clientDataJSON)),
        (n.attestationObject = fromByteArray(e.response.attestationObject)),
        (t.response = n),
        (document.getElementById("u2f_challenge_response").value =
          JSON.stringify(t)),
        document.getElementById("enrollment-form").submit();
...
var hasWebAuthnBrowserSupport = window.PublicKeyCredential;

if (hasWebAuthnBrowserSupport) {
  $("#u2f-not-supported").addClass("hidden");
  var request = JSON.parse($("#u2f_challenge").attr("value"));
  hasWebAuthnBrowserSupport && request.pubKeyCredParams
    ? webAuthnCreate(request)
    : ($("#u2f-supported").addClass("hidden"), $("#u2f-not-supported").show());
} else $("#u2f-supported").addClass("hidden"), $("#u2f-not-supported").show();

// Encoding/decoding logic source:
// https://github.com/Yubico/java-webauthn-server/blob/master/webauthn-server-demo/src/main/webapp/js/base64url.js
function toByteArray(e) {
  e = base64UrlToMime(e);
  var t = window.atob(e),
    n = t.length,
    r = new Uint8Array(n);
  for (var i = 0; i < n; i++) r[i] = t.charCodeAt(i);
  return r.buffer;
}
function fromByteArray(e) {
  var t = new Uint8Array(e),
    n = t.length,
    r = "";
  for (var i = 0; i < n; i++) r += String.fromCharCode(t[i]);
  return mimeBase64ToUrl(btoa(r));
}
function mimeBase64ToUrl(e) {
  return e.replace(/\+/g, "-").replace(/(\/)/g, "_").replace(/=/g, "");
}
function base64UrlToMime(e) {
  return (
    e.replace(/-/g, "+").replace(/_/g, "/") +
    "====".substring(0, (4 - (e.length % 4)) % 4)
  );
}
function excludedCredentialsToByteArray(e) {
  var t = e.length;
  for (var n = 0; n < t; n++)
    e[n] = { type: "public-key", id: toByteArray(e[n].id) };
  return e;
}
